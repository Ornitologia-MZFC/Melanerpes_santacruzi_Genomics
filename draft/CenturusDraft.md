...
Abstract.- The Velazquez woodpecker Centurus santacruzi (Aves: Picidae) is a polytypic species distributed from the center-east regions of Mexico to North Nicaragua and Honduras
islands. The ample morphological differentiation throughout its distribution has provoked the taxonomic recognition of several subspecies grouped in three main groups 
...
same way, this information allows to make inferences about the extent of hybridization events or incomplete lineage sorting in many taxa, offering new opportunities to understand
the complex phylogenetic relationships between the organisms (Twyford and Ennos 2012).
